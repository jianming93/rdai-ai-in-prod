...
CLIENT = chromadb.HttpClient(host=os.environ["VECTOR_STORE_URL"], port=os.environ["VECTOR_STORE_PORT"])
...
if __name__=="__main__":
    schedule.every(int(os.environ["REQUEST_INTERVAL"])).seconds.do(scheduled_feed_request)
    while True:
